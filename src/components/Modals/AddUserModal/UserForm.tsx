...
const UserForm = ({
  ...
  return (
    <form action="" className="flex flex-col w-full gap-1 pl-1">
      <label htmlFor="name" className="text-primary_font font-semibold">
        Enter Name
      </label>
      <input
        type="text"
      ...
      <label htmlFor="email" className="text-primary_font font-semibold mt-3">
        Enter Email ID{' '}
        {emailValid ? (
          ''
        ) : (
      ...
      <div className="flex gap-6 w-full mt-3">
        <div className="flex flex-col gap-1 w-full">
          <label htmlFor="username" className="text-primary_font font-semibold">
            Enter Username{' '}
            {usernameValid ? (
              ''
            ) : (
              <span className="text-red-400 font-medium text-xs">
                (User name is taken/invalid)
              </span>
            )}
          </label>
          <input
        ...
        <div className="flex flex-col gap-1 w-full">
          <label htmlFor="contact" className="text-primary_font font-semibold">
            Enter Contact no.
          </label>
