...
const UserUpload = ({setUploadedFile}: Props) => {
  ...
  return (
    <div {...getRootProps()} className={`w-[100%] cursor-pointer h-[12rem] mr-2 bg-primary_bg rounded-md flex justify-center items-center border-dashed border-[2px] border-[#c7c7c7]`}>
      ...
      <div className='flex flex-col justify-center items-center gap-3'>
        ...
        {failed && <p className='text-[#FF0000] text-xs font-normal'>Please upload a .csv file</p>}
      </div>
    </div>
  )
}
