  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild >
        <Button className='text-[0.8rem] font-normal p-2 h-5 rounded-lg hover:bg-[#628CE9]'>Manage</Button>
      </AlertDialogTrigger>
      <AlertDialogContent className='w-[40rem] pb-4'>
        ...
        <AlertDialogDescription className='h-[13vh] flex flex-col gap-4 pl-2 justify-between'>
          ...
          <div className='h-8 flex gap-2'>
            <p className='text-black font-medium text-xs leading-6'>Current allotted storage : </p>
            <p className='h-7 w-16 rounded-md text-center leading-6 bg-[#D1DFFF] text-primary_font text-base font-semibold'> {storage?.alloted} </p>
            <p className='text-black font-medium text-sm leading-6'>/ {storage?.total} GB</p>
          </div>
        </AlertDialogDescription>
