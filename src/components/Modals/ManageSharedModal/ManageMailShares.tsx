...
const ManageMailShares = (props: Props) => {
  return (
    <div className="w-full h-[13.5rem] flex flex-col gap-2 p-4 mt-4 border border-solid border-[#7A7AFF] rounded-2xl">
      <div className='w-full h-14 flex justify-between items-center px-4 cursor-pointer border border-solid border-[#CEDDFF] hover:bg-[#F5F8FF] rounded-lg'>
        ...
        <div className="flex gap-3">
          <button title='Favourite' className='flex items-center justify-center rounded-lg h-8 w-[5rem] border border-[#8E8EFF] bg-white hover:bg-[#DEE8FF]'>
            <p className="text-[#8E8EFF]">Manage</p>
          </button>
          <button title='Favourite' className='flex items-center justify-center rounded-lg h-8 w-8  bg-white hover:bg-[#DEE8FF]'>
...
export default ManageMailShares