      ...
      <div className="flex flex-col gap-4 h-full pr-2 overflow-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          {settings.expiry && (
            <form className="flex gap-10">
              <div className="flex gap-4">
                <label
                  htmlFor="dateInp"
                  className="flex justify-center items-center h-10 w-[12rem] rounded-sm bg-bg_hover text-primary_font"
                >
                  {settings.expiryDate || 'DD-MM-YY'}
                </label>
          ...
          {settings.password && (
            <form action="" autoComplete="off">
              <input
                ...
                onChange={(e) =>
                  setSettings({ ...settings, passwordValue: e.target.value })
                }
          ...
          <SwitchFields
            ...
            setChecked={(value) =>
              setSettings({ ...settings, accesslimit: value })
            }
          />
            ...
            <div className="flex justify-between">
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    accessValue: Number(e.target.value),
                  })
                }
              ...
              <div className="flex flex-col gap-2">
                <Image
                  ...
                  height={4}
                  alt="+1"
                  className="w-4 h-4 bg-bg_hover rounded-sm"
          ...
          <SwitchFields
            ...
            setChecked={(value) => {
              setSettings({ ...settings, shareable: value });
            }}
          />
          ...
          <SwitchFields
            ...
            setChecked={(value) =>
              setSettings({ ...settings, downloadable: value })
            }
          />
