      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="w-[35vw] pt-4">
          <AlertDialogHeader className="flex flex-row items-center justify-between">
            <div className="flex gap-3">
              ...
              <div className="flex flex-col h-full">
                <AlertDialogTitle className="font-medium text-[0.9rem]">
                  Do you want to expire all the links on this domain?
                </AlertDialogTitle>
          ...
          <AlertDialogDescription className="h-[12rem] flex items-center justify-between px-10 gap-4">
            {buttonHeld ? (
              <Button className="h-[10rem] p-0 w-[10rem] flex items-center justify-center bg-[#FF6161] hover:bg-[#FF6161] flex-col border-2 border-solid border-[#FF6161] rounded-[2.5rem]">
              ...
              <Button
                ...
                style={{
                  background: `linear-gradient(to top, #FF6161 ${
                    progress * 33.33
                  }%, transparent ${progress * 33.33}%, transparent 100%)`,
                }}
              >
                <p
                  className={`font-semibold text-lg text-${
                    progress >= 1.6 ? 'white' : '[#FF6161]'
                  }`}
                >
                  Apply SOS
                </p>
                ...
                <p
                  className={`text-xs font-normal text-${
                    progress >= 1.3 ? 'gray-100' : 'gray-400'
                  }`}
                >
                  click & hold for 3s to apply
                </p>
              </Button>
            )}
          </AlertDialogDescription>
