          ...
          <AlertDialogDescription className="text-xs text-[#979797] flex flex-col gap-4 pl-2">
            <div className="flex justify-between items-center">
              <div className="h-8 flex gap-2 items-center">
                ...
                <p className="text-primary_font font-medium text-sm leading-6">
                  {' '}
                  {user?.storage.storage_used} /
                </p>
                <p className="p-[0.15rem] px-3 rounded-md text-center leading-8 bg-[#D1DFFF] text-primary_font text-sm font-medium">
                  {visualTotalStorage} GB
                </p>
              </div>

              <button
                className="p-1 px-2 rounded-md text-center leading-6 bg-[#D1DFFF] text-primary_font_2 text-sm font-medium"
            ...
            <p>
              *you can only add storage upto{' '}
              <span className="text-xs font-medium">-- GB</span>
            </p>
          </AlertDialogDescription>
          <AlertDialogFooter className="flex gap-4">
            <AlertDialogAction
              className="w-[50%] rounded-full text-white bg-primary_font hover:bg-[#628CE9]"
              onClick={handleSave}
            >
              Save
            </AlertDialogAction>
