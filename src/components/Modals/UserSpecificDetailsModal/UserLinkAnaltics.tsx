  ...
  return (
    <div className="w-[60%] bg-primary_bg rounded-xl p-3 px-6">
      <div className="flex gap-2 h-5">
        ...
        <p className="text-primary_font text-md font-medium leading-4">
          Link Analytics
        </p>
      </div>
        ...
        <div className="flex flex-col gap-[0.1rem] w-[50%] h-full justify-center pl-2">
          <div className="flex gap-2 items-center">
            ...
            <p className="text-[#afafaf] text-[0.83rem] font-medium">
              <span className="text-gray-400 text-[0.92rem] font-medium">
                {user?.links.active_links || 0}{' '}
              </span>
              Active
            </p>
          </div>
          <div className="flex gap-2 items-center">
            ...
            <p className="text-[#afafaf] text-[0.83rem] font-medium">
              <span className="text-gray-400 text-[0.92rem] font-medium">
                {user?.links.expired_link || 0}{' '}
              </span>
              Expired
            </p>
          </div>
          <p className="text-[#afafaf] text-[0.83rem] font-medium">
            <span className="text-primary_font text-base font-semibold">
              {user?.links.total_link || 0}{' '}
            </span>
            Total links{' '}
          </p>
        </div>
