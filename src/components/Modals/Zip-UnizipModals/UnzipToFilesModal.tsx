    ...
    <AlertDialog>
        <AlertDialogTrigger asChild >
          {multiplefiles 
            ...
            : <p onClick={(e) => e.stopPropagation()} className='w-full'>Extract to</p>
          }
        </AlertDialogTrigger>
        <AlertDialogContent className='w-[40rem]'>

          <AlertDialogHeader className='flex flex-row h-10 justify-between'>
            <AlertDialogTitle className='font-bold text-xl text-black mt-1 pt-[0.3rem]'>Extract Content</AlertDialogTitle>
          ...
          <div>
            <div className='flex gap-4 pl-4 bg-primary_bg border-[1px] items-center border-solid border-primary_border rounded-md h-12'>
              ...
              <p className='text-primary_font_2 text-base w-[80%] truncate'>{files[0].name}</p>
            </div>
          </div>
