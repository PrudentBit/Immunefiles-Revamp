...
const ZipFilesAlert = (props : Props) => {
    ...
    <>
      <AlertDialog>
        <AlertDialogTrigger asChild>
					<Image src='/zip-icon.svg' onClick={(e) => e.stopPropagation()} width={16} height={16} alt='Delete icon'/>
        </AlertDialogTrigger>
        <AlertDialogContent className='translate-y-[-165%] gap-5'>
          <AlertDialogHeader className='flex flex-row items-center gap-3'>
            ...
            <AlertDialogTitle className='font-medium text-md pb-1'>
              <div className='flex flex-col'>
                ...
                <p className='text-xs text-[#87898E] font-normal'>You can unzip the files anytime you want.</p>
              </div>
            </AlertDialogTitle>
          </AlertDialogHeader>
          <AlertDialogDescription className='flex gap-4 pl-2'>
            <Image src='/FileIcons/zip.svg' width={30} height={30} alt='zip icon'/>
            <input 
              type='text' 
          ...
          <AlertDialogFooter className='flex gap-4'>
            <AlertDialogAction className='w-[50%] rounded-full bg-primary_font text-white hover:bg-bg_hover' onClick={handleZipFiles}>Yes! Archive</AlertDialogAction>
