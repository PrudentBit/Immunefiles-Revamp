...
const BotLeftAlert: React.FC<BotLeftAlertProps> = ({ children, className, image, imagebg }) => {
  return (
    <div className={`absolute bottom-[5%] right-[3%] w-[27rem] h-[5.5rem] bg-white rounded-lg z-50 flex items-center justify-between gap-3 p-4 shadow-[0_2px_20px_0px_rgba(0,0,0,0.2)] ${className}`}>
